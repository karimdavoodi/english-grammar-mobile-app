...
export function StatsScreen({ stats, onOpenReview, onBack }: StatsScreenProps) {
  ...
  return <View style={styles.screen} testID="stats-screen">
    <Text style={styles.heading} accessibilityRole="header" testID="stats-heading">Your stats</Text>
    ...
    {onBack ? <Pressable testID="stats-back" accessibilityRole="button" onPress={onBack} style={styles.back}>
